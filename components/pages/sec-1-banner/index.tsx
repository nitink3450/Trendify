...
const SecBanner1 = () => {
  return (
    <>
      <div className="relative flex flex-col justify-center items-center w-full gap-[207px] mt-[80px]">
        <div className="wrapper w-full flex justify-start flex-col gap-[31px]">
          <div className="max-w-[650px] font-bold text-[48px] leading-[61px] ">
            Your bootstrap Partners for a professional, successful Go-to-market
            launch.
          </div>
          <div className="max-w-[683px] font-bold text-[16px] leading-[26px] opacity-80">
        ...
        <div className="font-bold text-[42px] leading-[44px] flex justify-center items-center p-[79.5px_109px] max-w-[1374px] rounded-[30px] bg-[#0000004d] text-center backdrop-blur-[10px] mx-[10px] z-10">
